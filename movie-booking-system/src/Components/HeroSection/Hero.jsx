...
const Hero = () => {
  ...
  return (
    <div className='flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-cover h-screen bg-center' style={{ backgroundImage: `url(${assets.backgroundImage})` }}>
        ...
        <h1 className='text-5xl font-semibold md:text-[70px] md:leading-18 max-w-200'>Guardians <br/>of the Galaxy</h1>
        ...
        <button  onClick= {() => navigate('/movie')} className='flex items-center gap-2 p-4 bg-red-400 rounded-full font-semibold'>Explore Movie <span><ArrowRight/></span></button>
